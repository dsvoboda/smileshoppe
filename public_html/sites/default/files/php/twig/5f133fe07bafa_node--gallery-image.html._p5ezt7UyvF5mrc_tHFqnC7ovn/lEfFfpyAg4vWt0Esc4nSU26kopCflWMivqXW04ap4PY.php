...
class __TwigTemplate_5e442028c9f4094f2bdff3cce2db878b599034eec4eb6ca227fa7cfc6a3e25d7 extends \Twig\Template
{
...
\t]
%}
<div{{ attributes.addClass(classes).setAttribute('id','node-'~node.id()).setAttribute('data-id',node.id()).setAttribute('data-category',node.field_category.target_id) }}>
\t{{ title_prefix }}{{ title_suffix }}
\t<div class=\"images\">
\t\t<div class=\"before\">
\t\t\t<p><strong>Before</strong></p>
\t\t\t<img src=\"{{ file_url(node.field_before_image.entity.uri.value) }}\" alt=\"\" />
\t\t</div>
\t\t<div class=\"after\">
\t\t\t<p><strong>After</strong></p>
\t\t\t<img src=\"{{ file_url(node.field_after_image.entity.uri.value) }}\" alt=\"\" />
\t\t</div>
\t</div>
\t<div class=\"information\">
\t\t<h2>{{ label }}</h2>
...
", "themes/custom/smileshoppe/templates/content/node--gallery-image.html.twig", "/nfs/c03/h03/mnt/49724/domains/dsvoboda.com/html/themes/custom/smileshoppe/templates/content/node--gallery-image.html.twig");
    }
}
